...
class VGG19:
    def __init__(self):
       ...
       # Block 1
        model.add(Conv2D(64, (3, 3), padding='same', kernel_regularizer=keras.regularizers.l2(0.0001),
                         kernel_initializer=he_normal(), name='block1_conv1', input_shape=[227, 227, 3]))
        ...
        # Block 2
        model.add(Conv2D(128, (3, 3), padding='same', kernel_regularizer=keras.regularizers.l2(0.0001),
        ...
        # Block 3
        model.add(Conv2D(256, (3, 3), padding='same', kernel_regularizer=keras.regularizers.l2(0.0001),
        ...
        # Block 4
        model.add(Conv2D(512, (3, 3), padding='same', kernel_regularizer=keras.regularizers.l2(0.0001),
        ...
        model.add(Dense(4096, use_bias=True, kernel_regularizer=keras.regularizers.l2(0.0001),
                        kernel_initializer=he_normal(), name='fc_cifa10'))
        model.add(BatchNormalization())
        model.add(Activation('relu'))
        model.add(Dropout(0.5))
        model.add(Dense(4096, kernel_regularizer=keras.regularizers.l2(0.0001),
                        kernel_initializer=he_normal(), name='fc2'))
        model.add(BatchNormalization())
        model.add(Activation('relu'))
        model.add(Dropout(0.5))
        model.add(Dense(10, kernel_regularizer=keras.regularizers.l2(0.0001),
